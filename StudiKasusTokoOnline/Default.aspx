<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="StudiKasusTokoOnline._Default" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">

    <div class="jumbotron">
        <h1>Welcome to our store!</h1>
        <p class="lead">Bookquarium store is an online shop that sells books in the IT field. click learn more for more information about the IT field</p>
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <p>
                <a class="btn btn-default" href="https://medium.com/sjsuischool/informatics-careers-what-it-takes-and-how-to-get-there-6f98a1795bc#:~:text=In%20its%20broadest%20sense%2C%20informatics,all%20about%20the%20end%20user.">Learn more &raquo;</a>
            </p>
        </div>
        <div class="col-md-4">
            ...
            <p>
                <a class="btn btn-default" href="https://en.wikipedia.org/wiki/Programming_language">Learn more &raquo;</a>
            </p>
        </div>
        <div class="col-md-4">
            <h2>How to Learn</h2>
            ...
            <p>
                <a class="btn btn-default" href="https://www.codingdojo.com/blog/7-tips-learn-programming-faster">Learn more &raquo;</a>
            </p>
        </div>
    </div>
